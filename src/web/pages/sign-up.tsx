    ...
    <div className="min-h-screen bg-charcoal flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8 bg-[#1A1A1A] p-8 rounded-2xl border border-white/5 shadow-2xl">
        <div className="text-center">
          ...
          <p className="text-gray-400 font-sans">Create Staff Account</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6">
          ...
          <div className="text-center text-sm text-gray-500 pt-4">
            Already have an account? <Link href="/sign-in" className="text-mustard hover:underline">Sign In</Link>
          </div>
        </form>
      </div>
    </div>
